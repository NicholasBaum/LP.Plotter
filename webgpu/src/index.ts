...
import { AAModes, FastLineRenderer } from "./fastLineRenderer";
...
//let data = DataGenerator.createRunData(1, 5);
let data = DataGenerator.createSessionData(1, 20, 12);
//let data = DataGenerator.issueTooLongInnerMiter2();
let renderer = new FastLineRenderer(canvas, data[0], AAModes.MSAA4);
