...
public static class RenderMethods
{
    ...
    public static void RenderHighDensity(double[] yValues, Span xDataRange, Axis xAxis, Axis yAxis, SKCanvas canvas, SKPaint paint, LPSize size)
    {
    ...
    public static Span[] GetVerticalBars(double[] yValues, Span xDataRange, Axis xAxis, Axis yAxis, LPSize size)
    {
    ...
    public static void CreateDecimatedPath2(double[] yValues, Span xDataRange, Axis xAxis, Axis yAxis, LPSize size, SKPath path)
    {
        var imageWidth = size.Width;
        var imageHeight = size.Height;
        SKSpaceTransform t = new(imageWidth, imageHeight, xAxis.Range, yAxis.Range);
    ...
    public static void CreateDecimatedPath(double[] yValues, Span xDataRange, Axis xAxis, Axis yAxis, LPSize size, SKPath path)
    {
        var imageWidth = size.Width;
        var imageHeight = size.Height;
        SKSpaceTransform t = new(imageWidth, imageHeight, xAxis.Range, yAxis.Range);
    ...
    public static void CreatePath(double[] yValues, Span xDataRange, Axis xAxis, Axis yAxis, LPSize size, SKPath path)
    {
        var imageWidth = size.Width;
        var imageHeight = size.Height;
        SKSpaceTransform t = new(imageWidth, imageHeight, xAxis.Range, yAxis.Range);
